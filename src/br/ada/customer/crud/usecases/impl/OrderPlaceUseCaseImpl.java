...
public class OrderPlaceUseCaseImpl implements IPlaceOrderUseCase {
    ...
    public void placeOrder(Order order) {
        placeOrder.addItemValidation(order);
        statusOrder.statusValidation(order, OrderStatus.OPEN);
        placeOrder.cardValidation(order);
        placeOrder.validationTotal(order);
